...
def align_to_reference(sample,fastq2):
    ...
    _cmd['sort']='''/OIU/sge_software/samtools/currentVersion/samtools sort -@ 8 {prefix}.Aligned.toTranscriptome.out.bam -o {prefix}.Aligned.toTranscriptome.out_sort.bam'''.format(prefix=sample)
